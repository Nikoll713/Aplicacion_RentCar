...
from Views.paginaBusqueda import Ui_PaginaBusqueda
from Views.paginaSalida import Ui_PaginaSalida
from PyQt5 import QtCore, QtGui, QtWidgets

class Ui_PaginaPrincipal(object):

    def __init__(self):
        self.principalController = PrincipalController(self)
    ...
    def setupUi(self, PaginaPrincipal):
        ...
        #--------------------Events--------------------------------------
        self.btn_busqueda.clicked.connect(lambda:self.principalController.GoView(PaginaPrincipal,Ui_PaginaBusqueda))
        self.btn_salida.clicked.connect(lambda:self.principalController.GoView(PaginaPrincipal,Ui_PaginaSalida))
        #--------------------End Events---------------------------------
